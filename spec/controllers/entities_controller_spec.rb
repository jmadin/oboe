...
describe EntitiesController do
  ...
  let(:valid_attributes) { { "entity_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved entity as @entity" do
        ...
        post :create, {:entity => { "entity_name" => "invalid value" }}, valid_session
        assigns(:entity).should be_a_new(Entity)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested entity" do
        ...
        Entity.any_instance.should_receive(:update).with({ "entity_name" => "MyString" })
        put :update, {:id => entity.to_param, :entity => { "entity_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the entity as @entity" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Entity.any_instance.stub(:save).and_return(false)
        put :update, {:id => entity.to_param, :entity => { "entity_name" => "invalid value" }}, valid_session
        assigns(:entity).should eq(entity)
      end
