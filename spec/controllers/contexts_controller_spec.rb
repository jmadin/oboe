  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved context as @context" do
        ...
        post :create, {:context => { "project" => "invalid value" }}, valid_session
        assigns(:context).should be_a_new(Context)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested context" do
        ...
        Context.any_instance.should_receive(:update).with({ "project" => "" })
        put :update, {:id => context.to_param, :context => { "project" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the context as @context" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Context.any_instance.stub(:save).and_return(false)
        put :update, {:id => context.to_param, :context => { "project" => "invalid value" }}, valid_session
        assigns(:context).should eq(context)
      end
