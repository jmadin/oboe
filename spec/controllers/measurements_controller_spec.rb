...
describe MeasurementsController do
  ...
  let(:valid_attributes) { { "observation" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved measurement as @measurement" do
        ...
        post :create, {:measurement => { "observation" => "invalid value" }}, valid_session
        assigns(:measurement).should be_a_new(Measurement)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested measurement" do
        ...
        Measurement.any_instance.should_receive(:update).with({ "observation" => "" })
        put :update, {:id => measurement.to_param, :measurement => { "observation" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the measurement as @measurement" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Measurement.any_instance.stub(:save).and_return(false)
        put :update, {:id => measurement.to_param, :measurement => { "observation" => "invalid value" }}, valid_session
        assigns(:measurement).should eq(measurement)
      end
