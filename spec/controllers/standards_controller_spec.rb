...
describe StandardsController do
  ...
  let(:valid_attributes) { { "standard_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved standard as @standard" do
        ...
        post :create, {:standard => { "standard_name" => "invalid value" }}, valid_session
        assigns(:standard).should be_a_new(Standard)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested standard" do
        ...
        Standard.any_instance.should_receive(:update).with({ "standard_name" => "MyString" })
        put :update, {:id => standard.to_param, :standard => { "standard_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the standard as @standard" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Standard.any_instance.stub(:save).and_return(false)
        put :update, {:id => standard.to_param, :standard => { "standard_name" => "invalid value" }}, valid_session
        assigns(:standard).should eq(standard)
      end
